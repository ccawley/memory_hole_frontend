            ...
            <Grid.Column textAlign='center' width={13} className='dailyCard'>
              <Form>
                <Form.Group grouped>
                  ...
                  <TextArea placeholder='What are you thankful for right now?' rows={1} onSubmit={this.props.onSubmit} />
                  <TextArea placeholder='What ELSE are you thankful for tonight?' rows={1} onSubmit={this.props.onSubmit} />
                  ...
                  <Link to="/journal"><Button type='submit'>Next!</Button></Link>
                </Form.Group>
              </Form>
            </Grid.Column>
          </Grid.Row>
